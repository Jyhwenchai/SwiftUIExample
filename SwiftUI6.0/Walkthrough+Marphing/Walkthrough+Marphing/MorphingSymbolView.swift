...
struct MorphingSymbolView: View {
  ...
  struct Config {
    ...
    var symbolAnimation: Animation = .smooth(duration: 0.5)
  }
}

#Preview {
  MorphingSymbolView(symbol: "gearshape.fill", config: .init(font: .system(size: 100, weight: .bold), frame: CGSize(width: 250, height: 200), radius: 15, foregroundColor: .black, keyFrameDuration: 0.4))
}
